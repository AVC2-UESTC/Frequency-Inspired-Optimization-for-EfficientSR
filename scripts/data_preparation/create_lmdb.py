...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    # folder_path = '/home/liao/DIV2K_train_HR_sub'
    # lmdb_path = '/home/liao/DIV2K_train_HR_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx2 images
    # folder_path = '/home/liao/X2_sub'
    # lmdb_path = '/home/liao/DIV2K_train_LR_bicubic_X2_sub.lmdb'
    # img_path_list, keys = prepare_keys_div2k(folder_path)
    # make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    ...
    # LRx4 images
    folder_path = '/datadisk/liao/sr/DIV2K/DIV2K_train_LR_bicubic/X4_sub'
    lmdb_path = '/datadisk/liao/sr/DIV2K/DIV2K_train_LR_bicubic/DIV2K_train_LR_bicubic_X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
